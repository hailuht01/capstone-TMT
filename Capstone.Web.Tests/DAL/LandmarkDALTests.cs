...
namespace Capstone.Web.Tests.DAL
{
    ...
    public class LandmarkDALTests
    {
        ...
        public void GetAllLandmarks()
        {
            ...
            int itnID = new ItineraryDAL(connectionString).CreateItinerary(new Itinerary("Sample Itinerary", DateTime.Now.AddDays(1), 4.4, "This is a test description", "Admin@CityTour.com"));
            //Create Landmarks

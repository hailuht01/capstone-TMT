...
namespace Capstone.Web.Models
{
  public class Landmark
  {
    ...
    public static List<Landmark> GetSamples() => new List<Landmark>()
    {
      ...
      new Landmark(999998, "Cincinnati Museum Center", "1301 Western Ave, Cincinnati, OH 45203", "Family Friendly Museum! This place its awesome! You are really going to love it.", 39.110019, 39.110019, "Cincinnati-Museum.jpg"),
